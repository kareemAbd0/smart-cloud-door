...
int gpio_probe(struct platform_device *pdev)
{
    ...
    for_each_child_of_node(parent,child){
        ...
        dev_data->desc = devm_fwnode_get_gpiod_from_child(dev, "rpi", &child->fwnode, GPIOD_ASIS, dev_data->label);
...
int __init gpio_sysfs_init(void)
{
    ...
    gpio_drv_data.class_gpio = class_create(THIS_MODULE,"gpio-led");
